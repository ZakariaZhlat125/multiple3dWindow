...
if (new URLSearchParams(window.location.search).get("clear")) {
  ...
  function setupScene() {
	...
	let geometry = new t.SphereGeometry(1000, 32, 32); // Increase the radius and segments for a large sphere
	let material = new t.MeshBasicMaterial({ color: 0x0000ff, side: t.BackSide }); // Set the color and render on the backside
	backgroundSphere = new t.Mesh(geometry, material);
